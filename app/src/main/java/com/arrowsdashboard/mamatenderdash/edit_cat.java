...
public class edit_cat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cat_name.setText(prevelant.cat_item.getName());
        Picasso.get().load(prevelant.cat_item.getPhoto()).into(cat_image);
        ...
        add_cat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(url)){
                    Toast.makeText(edit_cat.this,"من فضلك قم بتحديد الصورة",Toast.LENGTH_LONG).show();
    ...
    private void savecategory() {
        ...
        String url1 = Const.HTTPS_RESTAUARANT_ARROWSCARS_COM + "/api/dashboard/categories/update/"+prevelant.cat_item.getId();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getBoolean("status")){
                                startActivity(new Intent(edit_cat.this,cat_page.class));
                            }
    ...
    private void uploadImage(final Bitmap bitmap){
        ...
        rQueue = Volley.newRequestQueue(edit_cat.this);
        ...
        if (requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE&&resultCode==RESULT_OK&&data!=null) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(edit_cat.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
