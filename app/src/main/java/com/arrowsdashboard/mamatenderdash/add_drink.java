...
public class add_drink extends AppCompatActivity {
    ...
    Button add_drink ;
    EditText drink_name,drink_price ;
    ProgressBar pload ;

    
    private Uri uri ;
    String url,drink_,price ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drink_image.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        add_drink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drink_ = drink_name.getText().toString();
                price = drink_price.getText().toString();
                if (TextUtils.isEmpty(url)){
                    Toast.makeText(add_drink.this,"من فضلك قم بتحديد الصورة",Toast.LENGTH_LONG).show();
                }else if (TextUtils.isEmpty(drink_)){
                    drink_name.setError("أكتب اسم الأضافة");
                }else if (TextUtils.isEmpty(price)){
                    drink_price.setError("أكتب سعر الأضافة");
                }else {
    ...
    private void savebanner() {
        ...
        String url1 = Const.HTTPS_RESTAUARANT_ARROWSCARS_COM + "/api/dashboard/drinks/create";
        StringRequest getRequest = new StringRequest(Request.Method.POST, url1,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response) {
                        // response
                        Log.d("bannerrrrr",response);
                        try {
                            pload.setVisibility(View.GONE);
                            JSONObject jsonObject = new JSONObject(response);
                            if (jsonObject.getBoolean("status")){
                                startActivity(new Intent(add_drink.this,drinks.class));
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(add_drink.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
    ...
    private void uploadImage(final Bitmap bitmap){
                    ...
                    public void onResponse(NetworkResponse response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getBoolean("status")) {
                                ...
                                Picasso.get().load(jsonObject.getString("data")).into(drink_image);
        ...
        rQueue = Volley.newRequestQueue(add_drink.this);
        ...
        if (requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE&&resultCode==RESULT_OK&&data!=null) {
            if (data != null) {
                ...
                try {
                    ...
                    uploadImage(getResizedBitmap(bitmap,512,512));
